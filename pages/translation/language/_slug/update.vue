<template>
	<div id="dashboard" v-if="loaded">
		...
		<div class="actions">
			...
			<nuxt-link to="/translation/language/create" class="success ml ten button pointer">
			...
			submit () {
				...
				me.$refs.form.validate().then(success => {
					if (!success) {
						...
						me.$axios.post(`v2/admin/language/update/${me.$route.params.slug}`, form_data).then(res => {
